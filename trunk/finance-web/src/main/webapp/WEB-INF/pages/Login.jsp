...
.nav{background:transparent url(images/ietheme/content-top-bg.gif) no-repeat scroll left top;height:26px;}
.login{width:600px;height:360px;background:url("images/login_bg.jpg");margin:0 auto;border:2px solid #FFFFFF;}
.content ul{list-style-type:none;color:#003366;font-weight:bold;padding:50px 0px 0px 100px}
...
.footer{background:transparent url(/images/ietheme/content-bottom-bg.png) no-repeat scroll 0 0;color:#282828;font-size:87%;
...
<body>
 <div id="wrap">
		<s:form action="Login" namespace="/"  name="Form0" cssClass="v">
			...
			<div class="content">
				<ul>
				    <li><font color="red"><s:property value="%{message}"></s:property></font></li>
					<li>用户名:<s:textfield name="loginUsername" cssClass="inpu"></s:textfield></li>
					<li>密　码:<s:password  name="loginPassword" cssClass="inpu"/></li>
					<li style="padding-left:55px;">
					<s:submit value="登录"  method="doLogin" cssClass="inbu"></s:submit>
